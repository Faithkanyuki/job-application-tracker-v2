...
This is a from-scratch rebuild of an earlier version of this project, Built directly with `create-next-app` on Next.js 16 and Tailwind CSS v4, rather than migrated forward from an older version.
